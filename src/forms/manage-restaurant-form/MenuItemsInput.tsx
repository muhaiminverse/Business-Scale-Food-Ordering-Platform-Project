    ...
    return (
        <div className="flex flex-row items-end gap-2">
            <FormField control={control} name={`menuItems.${index}.name`}
                render={({ field }) => (
                    <FormItem>
                        ...
                        <FormControl>
                            <Input {...field}   placeholder="Chesse Pizza" className="bg-white" />
                        </FormControl>
                    </FormItem>
                )}
            />
            ...
            <FormField control={control} name={`menuItems.${index}.price`}
                render={({ field }) => (
                    <FormItem>
                        <FormLabel className="flex items-center gap-1">Price (Tk)<FormMessage /></FormLabel>
                        <FormControl>
                            <Input {...field}   placeholder="12.55" className="bg-white" />
                        </FormControl>
                    </FormItem>
                )}
            />
